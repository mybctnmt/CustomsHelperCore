  ...
  >
    <a-spin :spinning="loading">
      <a-form-model ref="form" :model="entity" :rules="rules" v-bind="layout">
        <a-form-model-item label="风险评估结果" prop="Risk">
        ...
        <a-form-model-item label="处理日期" prop="SignDate">
...
export default {
  ...
  methods: {
    ...
    openForm(id, title) {
      ...
      if (id) {
        this.loading = true
        this.$http.post('/Dec/tdecrisk/GetTheData', { id: id }).then(resJson => {
          this.loading = false
    ...
    handleSubmit() {
      this.$refs['form'].validate(valid => {
        ...
        this.loading = true
        this.$http.post('/Dec/tdecrisk/SaveData', this.entity).then(resJson => {
          this.loading = false
