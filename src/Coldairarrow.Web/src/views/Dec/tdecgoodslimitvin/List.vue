          ...
          <a-col :md="4" :sm="24">
            <a-form-item label="查询类别">
              <a-select allowClear v-model="queryParam.condition">
                ...
                <a-select-option key="VinNo">VIN序号</a-select-option>
                <a-select-option key="BillLadDate">提/运单日期</a-select-option>
...
const columns = [
  ...
  { title: 'VIN序号', dataIndex: 'VinNo', width: '10%' },
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.loading = true
      this.$http
        .post('/Dec/tdecgoodslimitvin/GetDataList', {
      ...
      this.$confirm({
        ...
        onOk() {
          return new Promise((resolve, reject) => {
            thisObj.$http.post('/Dec/tdecgoodslimitvin/DeleteData', ids).then(resJson => {
              resolve()
